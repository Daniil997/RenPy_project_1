...
define gui.textbox_height = 1110
...
define gui.dialogue_xpos = 1608
define gui.dialogue_ypos = 300

## Максимальная ширина текста диалога в пикселях.
define gui.dialogue_width = 4464
...
define gui.button_borders = Borders(24, 24, 24, 24)
...
define gui.radio_button_borders = Borders(108, 24, 24, 24)

define gui.check_button_borders = Borders(108, 24, 24, 24)

define gui.confirm_button_text_xalign = 0.5

define gui.page_button_borders = Borders(60, 24, 60, 24)

define gui.quick_button_borders = Borders(60, 24, 60, 0)
define gui.quick_button_text_size = 84
...
define gui.choice_button_width = 4740
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(600, 30, 600, 30)
...
define gui.slot_button_width = 1656
define gui.slot_button_height = 1236
define gui.slot_button_borders = Borders(60, 60, 60, 60)
define gui.slot_button_text_size = 84
...
define config.thumbnail_width = 1536
define config.thumbnail_height = 864
...
define gui.skip_ypos = 60

## Вертикальная позиция экрана уведомлений.
define gui.notify_ypos = 270

## Интервал между выборами в меню.
define gui.choice_spacing = 132
...
define gui.confirm_frame_borders = Borders(240, 240, 240, 240)

## Рамки, используемые в частях экрана пропуска.
define gui.skip_frame_borders = Borders(96, 30, 300, 30)

## Рамки, используемые в частях экрана уведомлений.
define gui.notify_frame_borders = Borders(96, 30, 240, 30)
...
define gui.bar_size = 150
define gui.scrollbar_size = 72
define gui.slider_size = 150
...
define gui.bar_borders = Borders(24, 24, 24, 24)
define gui.scrollbar_borders = Borders(24, 24, 24, 24)
define gui.slider_borders = Borders(24, 24, 24, 24)

## Вертикальные границы.
define gui.vbar_borders = Borders(24, 24, 24, 24)
define gui.vscrollbar_borders = Borders(24, 24, 24, 24)
define gui.vslider_borders = Borders(24, 24, 24, 24)
...
define gui.history_height = 840

## Местоположение, ширина и выравнивание заголовка, показывающего имя говорящего
## персонажа.
define gui.history_name_xpos = 930
define gui.history_name_ypos = 0
define gui.history_name_width = 930
define gui.history_name_xalign = 1.0

## Местоположение, ширина и выравнивание диалогового текста.
define gui.history_text_xpos = 1020
define gui.history_text_ypos = 12
define gui.history_text_width = 4440
...
define gui.nvl_borders = Borders(0, 60, 0, 120)
...
define gui.nvl_height = 690

## Интервал между строчками в режиме NVL, если gui.nvl_height имеет значение
## None, а также между строчками и меню режима NVL.
define gui.nvl_spacing = 60

## Местоположение, ширина и выравнивание заголовка, показывающего имя говорящего
## персонажа.
define gui.nvl_name_xpos = 2580
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 900
define gui.nvl_name_xalign = 1.0

## Местоположение, ширина и выравнивание диалогового текста.
define gui.nvl_text_xpos = 2700
define gui.nvl_text_ypos = 48
define gui.nvl_text_width = 3540
...
define gui.nvl_thought_width = 4680
define gui.nvl_thought_xalign = 0.0

## Местоположение кнопок меню NVL.
define gui.nvl_button_xpos = 2700
...
init python:
    ...
    def touch():
        ...
        gui.quick_button_borders = Borders(240, 84, 240, 0)
    ...
    def small():
        ...
        ## Размеры шрифтов.
        gui.text_size = 180
        gui.name_text_size = 216
        gui.notify_text_size = 150
        gui.interface_text_size = 180
        gui.button_text_size = 180
        gui.label_text_size = 204

        ## Регулирует местоположение текстового окна.
        gui.textbox_height = 1440
        gui.name_xpos = 480
        gui.dialogue_xpos = 540
        gui.dialogue_width = 6600

        ## Изменяет размеры и интервалы различных объектов.
        gui.slider_size = 216

        gui.choice_button_width = 7440
        gui.choice_button_text_size = 180

        gui.navigation_spacing = 120
        gui.pref_button_spacing = 60

        gui.history_height = 1140
        gui.history_text_width = 4140

        gui.quick_button_text_size = 120
        ...
        gui.nvl_name_width = 1830
        gui.nvl_name_xpos = 1950

        gui.nvl_text_width = 5490
        gui.nvl_text_xpos = 2070
        gui.nvl_text_ypos = 30

        gui.nvl_thought_width = 7440
        gui.nvl_thought_xpos = 120

        gui.nvl_button_width = 7440
        gui.nvl_button_xpos = 120
